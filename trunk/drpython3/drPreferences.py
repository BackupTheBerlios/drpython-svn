...
'Interface Mode': [('save','interfacemode.pref',1), ('mode','interfacemode.pref.type',0)]}
...
class drPreferences:
	...
	def __init__(self, platform_is_windows, programdirectory = ""):
		...
		#normal
		self.txtPromptStyleDictionary[0] = "fore:#000000,back:#FFFFFF,size:12,face:fixed"
		if (self.platform_is_windows):
			self.txtPromptStyleDictionary[0] = "fore:#000000,back:#FFFFFF,size:8,face:Courier New"
		# line number (margin)
